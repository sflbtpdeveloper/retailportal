sap.ui.define([
    ...
    function (BaseController, ODataModel, MessageToast, MessageBox, Filter, FilterOperator, Table, Column, ColumnListItem, Text, JSONModel) {
        ...
        return BaseController.extend("zretail_sfl.fragments.OrderUpload", {
            onInit: function () {
                debugger;
            ...
            onDownloadTemplate: async function () {
                ...
                try {
                    ...
                    const templateUrl = await $.ajax({
                        url: "/nodeapp/OU_downloadTemplate",     // Your custom backend route
                    ...
                    link.download = "OrderTemplate.xlsx"; // File name to save as
            ...
            onErrorDownload: function (errors) {
                ...
                try {
                    ...
                    $.ajax({
                        url: "/nodeapp/OU_downloadError", // Node.js backend route
                        method: "POST",
                        contentType: "application/json",
                        ...
                        success: (response) => {
                            ...
                            const link = document.createElement("a");
                            link.href = downloadUrl;
                            link.download = "OrderUploadErrors.xlsx"; // File name to save as
                            document.body.appendChild(link);
                            link.click();
                            document.body.removeChild(link);
