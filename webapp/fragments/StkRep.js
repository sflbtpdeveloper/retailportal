sap.ui.define([
    ...
    return BaseController.extend("zretail_sfl.controller.StkRep", {
        formatter: formatter,
        onInit: function () {
            debugger;
        ...
        _readData: async function () {
            ...
            this.getView().byId(sFragmentId + "--__StkRepTable").setModel(oModel);

            // this.getView().byId("zretail_sfl.fragments.OrderAck--__StkRepTable").setModel(oModel);
            var that = this;
            ...
            try {
                ...
                const response = await $.ajax({
                    url: "/nodeapp/RetailStklist",     // Your custom backend route
                ...
                const RetailStkList = response;        // Extract DA list data                               
                console.log(RetailStkList);
                ...
                oJsonModel.setData(RetailStkList);
                ...
                that.getView().setModel(oJsonModel, "listModel");
                console.error("Error fetching Retail Stock List:", oErr);
        ...
        onWerks: function (oEvent) {
            ...
            var oTable = this.getView().byId(sFragmentId + "--__StkRepTable");
            var oBinding = oTable.getBinding("items");
            var aFilters = [];
        ...
        onDownloadExcel: function () {
            ...
            link.setAttribute("download", "Stock_data.csv"); // Set the filename
