sap.ui.define([
    ...
    function (BaseController, ODataModel, MessageToast, MessageBox) {
        ...
        return BaseController.extend("zretail_sfl.controller.StkUpload", {
            onInit: function () {
                debugger;
            ...
            onRemoveFile: function () {
                var oFileUploader = this.byId("stkfileUploader");
            ...
            onUploadPress: function () {
                ...
                var oClearTableContainer = this.getView().byId(sFragmentIdC + "--errorTableContainer_stock");
                oClearTableContainer.destroyItems();
                var oClearLinkContainer = this.getView().byId(sFragmentIdC + "--errorDownloadContainer_stock");
            ...
            _resetFileUploader: function () {
                ...
                var oFileUploader = this.getView().byId(this._sFragmentUniqueId + "--myFileUploadSTK");
                if (oFileUploader) {
            ...
            onDownloadTemplate: async function () {
                ...
                try {
                    ...
                    const templateUrl = await $.ajax({
                        url: "/nodeapp/ST_downloadTemplate",     // Your custom backend route
                    ...
                    link.download = "StockTemplate.xlsx"; // File name to save as
                    ...
                    vModel.create("/ValidationSet", vEntry, {
                        ...
                        success: (oData, response) => {
                            ...
                            if (errorRecords) {
                                ...
                                var oLink = this.getView().byId(sFragmentId + "--errorDownloadContainer_stock");
                                oLink.destroyItems();
                            }
                            ...
                            if (errors.length > 0) {    //errors
                                ...
                                var oErrorTableContainer = this.getView().byId(sFragmentId + "--errorTableContainer_stock");
            ...
            onErrorDownload: function (errors) {
                ...
                try {
                    ...
                    $.ajax({
                        url: "/nodeapp/OU_downloadError_stock", // Node.js backend route
                        method: "POST",
                        contentType: "application/json",
                        ...
                        success: (response) => {
                            ...
                            const link = document.createElement("a");
                            link.href = downloadUrl;
                            link.download = "StockUploadErrors.xlsx"; // File name to save as
                            document.body.appendChild(link);
                            link.click();
                            document.body.removeChild(link);
